...
namespace MOstafaMOhamedX\Crud\Commands;

use Illuminate\Console\Command;
use MOstafaMOhamedX\Crud\Formatters\Formatter;
use MOstafaMOhamedX\Crud\Generators\ControllerGen;
use MOstafaMOhamedX\Crud\Generators\ModelGen;
use MOstafaMOhamedX\Crud\Generators\PolicyGen;
use MOstafaMOhamedX\Crud\Generators\RouteGen;
use MOstafaMOhamedX\Crud\Generators\Templates;
use MOstafaMOhamedX\Crud\Generators\ViewGen;
use MOstafaMOhamedX\Crud\Utils\FileUtils;
use MOstafaMOhamedX\Crud\Utils\SchemaUtils;
use MOstafaMOhamedX\Crud\Utils\TextUtils;
