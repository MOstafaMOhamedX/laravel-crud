export default {
    ...
    themeConfig: {
        ...
        editLink: {
            pattern: 'https://github.com/MOstafaMOhamedX/laravel-crud/docs/:path'
        },
        search: {
            maxSuggestions: 10
        },
        footer: {
            ...
            copyright: 'Copyright © 2022-present Mostafa Mohamed'
        },
        socialLinks: [
            { icon: 'github', link: 'https://github.com/MOstafaMOhamedX/laravel-crud' }
        ],
    }
};
