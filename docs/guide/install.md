...
\MOstafaMOhamedX\Crud\Crud::routes(); 
```
...
- Resource Controller
  - `app/Http/Controllers/Admin/[Name].php`
- Model
  - `app/Model/[Name].php`
- Policy
  - `app/Policies/[Name]Policy.php`
- Routes
  - `routes/crud/admin/[name].php`
- Views
  - `resources/views/admin/[name]/(index|edit|create|show).blade.php`
