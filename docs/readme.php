...
if (!empty($md)) {
    $content = implode("\n", $md);
    $docs = "> ## Please see the [**full documentation here**](https://MOstafaMOhamedX.github.io/laravel-crud/).\n\n";
    ...
    $content = preg_replace("#\(/guide#", "(https://MOstafaMOhamedX.github.io/laravel-crud/guide", $content);
