...
Please see the [index page here](https://MOstafaMOhamedX.github.io/laravel-crud/guide/index.md#screenshots) 
for screenshots.
...
requires you
to [create your own templates](https://MOstafaMOhamedX.github.io/laravel-crud/guide/customization).
